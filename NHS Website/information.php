	...
	<head>
		...
		<script>
			function initialize(){
				...
				subMenu = document.getElementById("subm");
				...
				"<span id ='ctitle' class='title'>Important Files</span><br/> <div class='filed'></div>"
				];
			}
		...
		<div class="maincontainer">
			<div id="whiteb" class="bcontainer">
				...
				<div id="subm" class="submenu">
					...
					<div id="s3"class="subopt"onclick="changeContent(3);">Important Files</div>
				</div>
					...
					<div class='elist'>
						...
						<div class='chairs'>
							...
							<div class='col2'>
								...
								<b>Tours</b><br/>Helal Chowdhury<br/><i>hchowdhury3273@bths.edu</i><br/><br/>
				...
				<div id="foot" class="footer">
					...
					<?php
						if(isset($_SESSION['name'])){
							echo "<span class='lbut'>Signed in as ".$_SESSION['name']. "<form method = 'post' action = 'information.php'><input name='logout' type='hidden'/> <input value='Log out'type='submit'/></form></span>";
						}
						else{
